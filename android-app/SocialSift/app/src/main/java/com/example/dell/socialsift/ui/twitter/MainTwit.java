package com.example.dell.socialsift.ui.twitter;
...
public class MainTwit extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_twiter);
...
//                oauth_url = requestToken.getAuthorizationURL();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            try {
                AccessToken accessToken = twitter.getOAuthAccessToken(requestToken, verifier);
System.out.println("TOKENS" + accessToken.getToken() + " * " + accessToken.getTokenSecret());
                long userID = accessToken.getUserId();
                final User user = twitter.showUser(userID);
                String username = user.getName();
                ...
                loginLayout.setVisibility(View.GONE);
                shareLayout.setVisibility(View.VISIBLE);
                userName.setText(MainTwit.this.getResources().getString(
    ...
    class updateTwitterStatus extends AsyncTask<String, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MainTwit.this);
...
//                InputStream is = getResources().openRawResource(R.drawable.ic_bell);
//                statusUpdate.setMedia("test.jpg", is);
        ...
        protected void onPostExecute(Void result) {
            ...
            Toast.makeText(MainTwit.this, "Posted to Twitter!", Toast.LENGTH_SHORT).show();
