...
public class ApprovedBrandAdapter extends RecyclerView.Adapter<ApprovedBrandAdapter.CustomViewHolder> {
    ...
    private final ApprovedBrandAdapter.OnItemClickListener listener;
    ...
    public ApprovedBrandAdapter(Context mContext, List<DataArr> commonModel, ApprovedBrandAdapter.OnItemClickListener listener) {
    ...
    @Override
    public ApprovedBrandAdapter.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
//        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cart_ro, null);
        ...
        ApprovedBrandAdapter.CustomViewHolder viewHolder = new ApprovedBrandAdapter.CustomViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(ApprovedBrandAdapter.CustomViewHolder customViewHolder, int position) {
...
//            this.thumbnail = (ImageView) itemView.findViewById(R.id.thumbnail);
        ...
        public void bind(final DataArr commonModel, final ApprovedBrandAdapter.OnItemClickListener listener, final int position) {
