...
public class SessionManager {
    ...
    private static final String PREF_NAME = "SiftSocialSharedPref";
    ...
    //check wheather user id logged in or not
    ...
    //to check if shared pref with key exists or not
