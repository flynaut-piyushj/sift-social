...
public class CommonUtility {
	...
	public String getPhoneNumberWtOrWoExtension(String phoneNumber, boolean doAppendExtension) {
		String result=null;
	...
	public boolean sendMessage(String contactNumber, String message) throws Exception {
		contactNumber = getPhoneNumberWtOrWoExtension(contactNumber, false);
...
//			mimeMessage.setText(message);
	...
	*/
	...
	public boolean sendEmail(String subject, String message, String emailIds[]) {
        ...
        Authenticator auth = new Authenticator() {
            public PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("gdiitest@gmail.com", "gdiitest@1");
            }
        };
        Session session = Session.getInstance(properties, auth);
        // creates a new e-mail message
        Message msg = new MimeMessage(session);
        msg.setFrom(new InternetAddress("gdiitest@gmail.com"));
...
//		System.out.println(sdfIst.format(utcDate));
	...
	public String convertTimeInto12HrsFmt(String dateAndTime) throws ParseException {
