...
import com.sift.apis.crons.ScheduledTasks;
...
@EnableScheduling
@ComponentScan(basePackages = "com.sift.apis.*")
...
public class BaseModuleConfiguration extends WebMvcConfigurerAdapter implements SchedulingConfigurer {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.sift.api.beans.entity" });
...
*/
	...
	@Bean
	public Properties mailchimpProperties()throws IOException
	{
		return PropertiesLoaderUtils.loadProperties(new ClassPathResource("mailchimp.properties"));	
	}
